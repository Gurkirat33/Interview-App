...
const Home = () => {
  return (
    <div>
      {/* Hero section */}
      <section className="bg-primary-100 bg-[url('/src/assets/hero-bg.svg')] bg-cover bg-no-repeat py-8 bg-blend-overlay">
      ...
      <section className="section-container">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row">
          {FeaturesData.map((item) => (
            <div
              key={item.heading}
              className="flex flex-col rounded-md border-2 p-4 shadow-lg"
            >
              <img
                src={item.icon}
                alt="icon"
